    ...
    private void setLocalization() {
        ...
        switch (currentLang) {
            case SpStorage.Constants.LANG_ENG:
                ((ImageView) mContentView).setImageResource(R.drawable.mayors4);
                dummy_button.setText("Get Started");
                break;
            case SpStorage.Constants.LANG_HINDI:
                ((ImageView) mContentView).setImageResource(R.drawable.mayors_message_hindi);
                dummy_button.setText("शुरुआत करे");
                break;
            case SpStorage.Constants.LANG_MARATHI:
                dummy_button.setText("सुरु करा");
                ((ImageView) mContentView).setImageResource(R.drawable.mayors_message_marathi);
                break;
        }
    }
